...
describe("PostgreSQL 17 Query Parsing (Full)", () => {
  before(async () => {
  ...
  describe("Full version functionality", () => {
    it("should have deparse functionality", () => {
      expect(query.deparse).to.be.a('function');
      expect(query.deparseSync).to.be.a('function');
    });

    it("should have scan functionality", () => {
      expect(query.scan).to.be.a('function');
      expect(query.scanSync).to.be.a('function');
    });

    it("should deparse a simple query", async () => {
    ...
    it("should scan a simple query", async () => {
      const result = await query.scan("SELECT 1");
